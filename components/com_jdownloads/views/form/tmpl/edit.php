...
<!-- Publishing TAB -->                        
	<?php
		if ($rules->uploads_use_tabs){
           echo $pane->startPanel(JText::_('COM_JDOWNLOADS_FORM_LABEL_TAB_PUBLISHING'),'publishing');
		}
    ?>
...
<!-- Files TAB -->
      ...
      <?php 
		if ($rules->uploads_use_tabs){       
			echo $pane->startPanel(JText::_('COM_JDOWNLOADS_FORM_LABEL_TAB_FILES'),'files');
		}
      ?>        
           ...
           <?php if ($rules->form_select_main_file):?> 
                <div class="formelm">
                 ...
                 <div class="formelm45">
                    ...
                    <?php echo '<small>'.JText::_('COM_JDOWNLOADS_BACKEND_FILESEDIT_ALLOWED_MAX_SIZE').' '.$rules->uploads_maxfilesize_kb.' KB</small><br /><br />'; ?>
                </div>
                <div>
                    <span style="margin:15px;"></span>
                </div>              
...
<!-- Images TAB -->      
       ...
       <?php if ($rules->form_images){
				if($rules->uploads_use_tabs){ 
                	echo $pane->startPanel(JText::_('COM_JDOWNLOADS_FORM_LABEL_TAB_IMAGES'),'images');
			    }       
		?>   
...
<!-- Additional TAB --> 
      ...
      <?php
		if($rules->uploads_use_tabs){      
       		echo $pane->startPanel(JText::_('COM_JDOWNLOADS_FORM_LABEL_TAB_ADDITIONAL'),'additional');
		}
      ?>
...
<!-- Description TAB -->      
      ...
      <?php
        if ($rules->form_short_desc || $rules->form_long_desc){
			if($rules->uploads_use_tabs){            
				echo $pane->startPanel(JText::_('COM_JDOWNLOADS_FORM_LABEL_DESCRIPTIONS'),'descriptions');
			}
      ?> 
        <fieldset>
...
<!-- Metadata TAB -->      
       ...
       <?php
             if ($rules->form_meta_desc || $rules->form_meta_key || $rules->form_robots){ 
 				if($rules->uploads_use_tabs){
                 	echo $pane->startPanel(JText::_('COM_JDOWNLOADS_FORM_LABEL_TAB_META_DATA'),'meta');
				}
       ?>   
	            <fieldset>
