...
setlocale(LC_ALL, 'C.UTF-8', 'C');
    ...
    if ($layout_text != ''){
        ...
        if ((int)$jlistConfig['use.tabs.type'] > 0){
           ...
           $body = str_replace('{tabs begin}', $jd_pane->startPane('jdpane'), $body);
           $body = str_replace('{tab description}', $jd_pane->startPanel(JText::_('COM_JDOWNLOADS_FE_TAB_DESCRIPTION_TITLE'), 'panel1'), $body);
           $body = str_replace('{tab description end}', $jd_pane->endPanel(JText::_('COM_JDOWNLOADS_FE_TAB_DESCRIPTION_TITLE'), 'panel1'), $body);
           $body = str_replace('{tab pics}', $jd_pane->startPanel(JText::_('COM_JDOWNLOADS_FE_TAB_PICS_TITLE'), 'panel2'), $body);
           $body = str_replace('{tab pics end}', $jd_pane->endPanel(JText::_('COM_JDOWNLOADS_FE_TAB_PICS_TITLE'), 'panel2'), $body);
           $body = str_replace('{tab mp3}', $jd_pane->startPanel(JText::_('COM_JDOWNLOADS_FE_TAB_AUDIO_TITLE'), 'panel3'), $body);
           $body = str_replace('{tab mp3 end}', $jd_pane->endPanel(JText::_('COM_JDOWNLOADS_FE_TAB_AUDIO_TITLE'), 'panel3'), $body);
           $body = str_replace('{tab data}', $jd_pane->startPanel(JText::_('COM_JDOWNLOADS_FE_TAB_DATA_TITLE'), 'panel4'), $body);
           $body = str_replace('{tab data end}', $jd_pane->endPanel(JText::_('COM_JDOWNLOADS_FE_TAB_DATA_TITLE'), 'panel4'), $body);
           $body = str_replace('{tab download}', $jd_pane->startPanel(JText::_('COM_JDOWNLOADS_FE_TAB_DOWNLOAD_TITLE'), 'panel5'), $body);
           $body = str_replace('{tab download end}', $jd_pane->endPanel(JText::_('COM_JDOWNLOADS_FE_TAB_DOWNLOAD_TITLE'), 'panel5'), $body);
           $body = str_replace('{tab custom1}', JDHelper::getOnlyLanguageSubstring($jd_pane->startPanel($jlistConfig['additional.tab.title.1']), 'panel6'), $body);
           $body = str_replace('{tab custom1 end}', JDHelper::getOnlyLanguageSubstring($jd_pane->endPanel($jlistConfig['additional.tab.title.1']), 'panel6'), $body);      
           $body = str_replace('{tab custom2}', JDHelper::getOnlyLanguageSubstring($jd_pane->startPanel($jlistConfig['additional.tab.title.2']), 'panel7'), $body);
           $body = str_replace('{tab custom2 end}', JDHelper::getOnlyLanguageSubstring($jd_pane->endPanel($jlistConfig['additional.tab.title.2']), 'panel7'), $body);
           $body = str_replace('{tab custom3}', JDHelper::getOnlyLanguageSubstring($jd_pane->startPanel($jlistConfig['additional.tab.title.3']), 'panel8'), $body);
           $body = str_replace('{tab custom3 end}', JDHelper::getOnlyLanguageSubstring($jd_pane->endPanel($jlistConfig['additional.tab.title.3']), 'panel8'), $body);
           $body = str_replace('{tabs end}', $jd_pane->endPane('jdpane'), $body);      
        } else {
