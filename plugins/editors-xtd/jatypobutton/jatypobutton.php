...
/**
 * ------------------------------------------------------------------------
 * JA Typo Button Plugin for J25 & J32
 * ------------------------------------------------------------------------
...
class plgButtonJaTypoButton extends JPlugin
{
	...
	function onDisplay($name)
	{
		...
		else if($app->isAdmin() && $option != 'com_content'){
			$view 		 = 'article';		
			$layout		 = 'edit';
		}
		...
		if (JRequest::getCmd('jatypo','')) {
			$tmpl = JPATH_PLUGINS.'/system/jatypo/jatypo/tmpl/default.php';
