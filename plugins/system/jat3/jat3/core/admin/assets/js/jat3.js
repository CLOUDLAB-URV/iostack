...
var JAT3_ADMIN = new Class({
	...
	fillData: function (profile, group){
		...
		// fix bug j3.6 the select auto disabled. so we enabled it.
		if (profile == 'default') {
			setTimeout(function(){jQuery('#jform_params_setting_menu, #jformparamshandheld_layout, #jformparamsiphone_layout, #jformparamsandroid_layout').removeAttr('disabled')}, 100);
		}
	},
