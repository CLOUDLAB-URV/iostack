        ...
        <script type="text/javascript">
            window.addEvent('load', function(){
                ...
                if(!placeholder){
                    ...
                    if (placeholder.id == 'nav-empty') { // fix for j360
                    	placeholder = placeholder.getParent();
                    	type = 0;
                    	stylej36='float:right;margin-right: 20px;margin-top: 5px;padding-left:20px;';
                    	position='bottom';
                    }
                }
                ...
                if(placeholder){
                    ...
                    new Element(type == 0 ? 'span' : 'li', {
                        ...
                        'style': (stylej36)+(type == 0 ? 'background: url(<?php echo JURI::root()?>plugins/system/jat3/jat3/core/admin/assets/images/ja.png) no-repeat' : '')
                    }).adopt(
                        new Element('a', {
                            'href':'javascript:void(0)',
                            'html': 'JAT3 Clean Cache',
                            'style': (stylej36==''?'':'color:#d9d9d9;text-decoration: none;'),
                            'events': {
                                'click': function(){
                                    new Request({
                                ...
                                'mouseenter': function() {this.setStyle('color', 'white');},
								'mouseleave': function() {this.setStyle('color', '#d9d9d9');}
                            }
                        })
                    ).inject(placeholder, position);
                }
            })
