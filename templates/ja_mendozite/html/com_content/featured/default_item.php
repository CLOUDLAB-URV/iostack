...
<?php if ($params->get('show_create_date')) : ?>
		<dd class="create">
		<?php echo JText::sprintf('<span>'.JHtml::_('date',$this->item->created, JText::_('DATE_FORMAT_LC1')).'</span>'); ?>
		</dd>
<?php endif; ?>
<?php if ($params->get('show_modify_date')) : ?>
		<dd class="modified">
		<?php echo JText::sprintf('<span>'.JHtml::_('date',$this->item->modified, JText::_('DATE_FORMAT_LC1')).'</span>'); ?>
		</dd>
<?php endif; ?>
<?php if ($params->get('show_publish_date')) : ?>
		<dd class="published">
		<?php echo JText::sprintf('<span>'.JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_LC1')).'</span>'); ?>
		</dd>
<?php endif; ?>
